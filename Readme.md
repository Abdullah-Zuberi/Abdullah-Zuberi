...
<h1>Hi 👋</h1>
<p> DevOps Enthusiast transitioning from Software Quality Assurance. Experienced with Git, Docker, Jenkins, Cypress, and modern development workflows. Focused on automation, CI/CD, and continuous improvement. </p>
...
### [CloudLit Cloud Engineer Intern Assessment](https://github.com/Abdullah-Zuberi/cloudlit-assessment)
Completed hands-on assessment demonstrating containerization, CI/CD pipelines, and web deployment.
* **Next.js & Docker**: Containerized Next.js frontend with multi-stage production Docker build optimizations.
* **Docker Compose Orchestration**: Configured unified service networking for both Next.js frontend and Jenkins controller.
* **Jenkins CI/CD**: Deployed and configured local Jenkins servers for development and production pipelines.
